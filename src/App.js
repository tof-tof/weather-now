...
function App() {
 //const [cityCard, setCityCard] = useState(<WeatherCard></WeatherCard>)
  const url = `http://api.openweathermap.org/data/2.5/weather?q=London,uk&appid=6a704e11e672d58e61bc84715b062d59&units=Metric`;
